...
# Set seed and generate new data for 2020
np.random.seed(2020)
n_points = 300
...
ax.set_title("Manhattan Industry Lease Clusters – 2020", fontsize=20, weight='bold')
...
plt.legend()
plt.tight_layout()
plt.savefig("manhattan_industry_clusters_2020.png", dpi=300, bbox_inches='tight')
plt.close()
