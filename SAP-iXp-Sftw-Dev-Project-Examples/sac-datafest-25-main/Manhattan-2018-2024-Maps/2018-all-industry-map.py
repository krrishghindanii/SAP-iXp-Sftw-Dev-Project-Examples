...
ax.set_title("Manhattan Industry Lease Clusters – 2018", fontsize=20, weight='bold')
...
plt.legend()
plt.tight_layout()
plt.savefig("manhattan_industry_clusters_clean.png", dpi=300, bbox_inches='tight')
plt.close()
