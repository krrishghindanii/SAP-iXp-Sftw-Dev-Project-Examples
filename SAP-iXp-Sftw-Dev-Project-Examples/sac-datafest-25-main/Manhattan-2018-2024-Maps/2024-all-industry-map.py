...
# Set seed and generate new data for 2024
np.random.seed(2024)
n_points = 300
...
ax.set_title("Manhattan Industry Lease Clusters – 2024", fontsize=20, weight='bold')
...
plt.legend()
plt.tight_layout()
plt.savefig("manhattan_industry_clusters_2024.png", dpi=300, bbox_inches='tight')
plt.close()
