...
# Set seed and generate new data for 2019
np.random.seed(2019)
n_points = 300
...
ax.set_title("Manhattan Industry Lease Clusters – 2019", fontsize=20, weight='bold')
...
plt.legend()
plt.tight_layout()
plt.savefig("manhattan_industry_clusters_2019.png", dpi=300, bbox_inches='tight')
plt.close()

# differences to see if markets gonna go up and down availability_propotion, features, rent, sublet and (go over the file)